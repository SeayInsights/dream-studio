...
def save_model(model: BaseModel, filepath: str, metadata: Optional[Dict[str, Any]] = None) -> bool:
    """
...
def is_model_stale(filepath: str, max_age_days: int = 7) -> bool:
    """
...
def cleanup_old_models(directory: str, max_age_days: int = 30, keep_latest: int = 5) -> int:
    """
