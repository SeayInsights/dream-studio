...
# frontend/static/{dashboard.css,dashboard.js}; mount that dir so the shell can
# load them as /static/* (loaded as classic scripts to preserve the global
# scope the 71 inline event handlers depend on).
