...
from .routes.project_drilldown import router as project_drilldown_router
...
app.include_router(prd_sow.router, prefix="/api/v1/prd-sow", tags=["prd-sow"])
...
# Drill-down: /projects/{id}/milestones, /milestones/{mid}/work-orders, /work-orders/{wid}/tasks
app.include_router(project_drilldown_router, prefix="/api/v1", tags=["projects"])
