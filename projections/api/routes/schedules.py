...
class ScheduleCreateRequest(BaseModel):
    ...
    format: str = Field(default="pdf", description="Export format: 'pdf', 'excel', 'pptx'")
    ...
    template: Optional[str] = Field(
        None, description="Optional template to use for report generation"
    )
    config: Optional[dict] = Field(
        None, description="Additional configuration for report generation"
    )
...
def get_scheduler() -> tuple:
    ...
    if _scheduler_instance is None:
        # Scheduled reports are projection service state in the canonical local DB.
...
async def list_schedules():
    ...
    try:
        ...
        return ScheduleListResponse(
            schedules=schedules, total=len(schedules), active=active_count, paused=paused_count
        )
...
async def create_schedule(request: ScheduleCreateRequest):
    ...
    try:
        ...
        return MessageResponse(message="Schedule created successfully", job_id=job_id)
...
async def update_schedule(
    job_id: str = Path(..., description="Schedule ID"), request: ScheduleUpdateRequest = None
):
    ...
    try:
        ...
        return MessageResponse(message="Schedule updated successfully", job_id=new_job_id)
...
async def pause_schedule(job_id: str = Path(..., description="Schedule ID")):
    ...
    try:
        ...
        return MessageResponse(message="Schedule paused successfully", job_id=job_id)
...
async def resume_schedule(job_id: str = Path(..., description="Schedule ID")):
    ...
    try:
        ...
        return MessageResponse(message="Schedule resumed successfully", job_id=job_id)
