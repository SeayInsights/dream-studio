...
class TestReportsAPI:
    ...
    def test_list_reports(self):
        ...
        create_response = client.post("/api/v1/reports/generate", json={"report_type": "detailed"})
    ...
    def test_get_report(self):
        ...
        # Create a report
        create_response = client.post("/api/v1/reports/generate", json={"report_type": "executive"})
    ...
    def test_delete_report(self):
        ...
        # Create a report
        create_response = client.post("/api/v1/reports/generate", json={"report_type": "summary"})
        report_id = create_response.json()["report_id"]
...
class TestExportsAPI:
    ...
    def report_id(self):
        ...
        response = client.post("/api/v1/reports/generate", json={"report_type": "detailed"})
    ...
    def test_export_csv_with_filters(self):
        ...
        response = client.get(f"/api/v1/export/csv?filters={filters}")
...
class TestSchedulesAPI:
    ...
    def test_update_schedule(self):
        ...
        if create_response.status_code == 201:
            ...
            # Update the schedule
            response = client.put(f"/api/v1/schedules/{job_id}", json={"name": "Updated Schedule"})
