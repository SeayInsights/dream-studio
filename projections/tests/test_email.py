...
class TestEmailSender:
    ...
    def email_sender(self, email_config):
        ...
        from projections.core.email.sender import EmailSender
    ...
    def test_send_email_multiple_recipients(self, email_sender):
        ...
        result = email_sender.send_email(
            to_addresses=recipients, subject="Team Report", body="Team analytics report"
        )
    ...
    def test_template_rendering(self, email_sender):
        ...
        from projections.core.email.template_renderer import TemplateRenderer

        renderer = TemplateRenderer()

        # Render simple template
        html = renderer.render_simple(title="Test Report", body="This is the report content")
    ...
    def test_send_html_email(self, email_sender):
        ...
        result = email_sender.send_email(
            to_addresses=["recipient@example.com"], subject="HTML Report", body=html_body, html=True
        )
    ...
    def test_smtp_connection_error(self, email_config):
        ...
        with patch("analytics.core.email.sender.smtplib.SMTP") as mock_smtp_class:
            ...
            result = sender.send_email(
                to_addresses=["recipient@example.com"], subject="Test", body="Test"
            )
...
class TestTemplateRenderer:
    ...
    def test_render_simple_template(self, renderer):
        ...
        html = renderer.render_simple(title="Test Title", body="Test body content")
    ...
    def test_render_with_special_characters(self, renderer):
        ...
        html = renderer.render_simple(title="Report <Test>", body="Value: 100 > 50 & 50 < 100")
    ...
    def test_full_report_email_workflow(self, temp_attachment):
        ...
        with patch("analytics.core.email.sender.smtplib.SMTP"):
            ...
            body = renderer.render_simple(
                title="Analytics Report", body="Your weekly analytics report is attached."
            )
