...
def test_generate_insights():
    ...
    metrics = {
        "sessions": {"total_sessions": 100, "outcomes": {"success": 85, "failed": 15}},
        "tokens": {"total_tokens": 50000, "total_cost_usd": 2.50},
        "models": {
            "by_model": {
            ...
            "improvement_opportunities": [
                {
                    ...
                    "success_rate": 60,
                    "count": 10,
                    "recommendation": "Review skill-c",
                }
            ],
        },
        "trends": {"sessions": {"trend": "increasing", "slope": 2.5, "volatility": 10.0}},
    }
...
def test_identify_strengths():
    ...
    metrics = {"sessions": {"total_sessions": 100, "outcomes": {"success": 90, "failed": 10}}}

    analysis = {"performance": {"high_performers": ["skill-a", "skill-b", "skill-c"]}}
...
def test_identify_issues():
    ...
    analysis = {"performance": {"underperformers": ["skill-x", "skill-y"]}}
...
def test_get_high_priority_insights():
    ...
    analysis = {
        "performance": {"high_performers": ["skill-a"], "underperformers": ["skill-b", "skill-c"]},
        "anomalies": {"overall_health": "critical", "anomaly_count": 10},
    }
...
def test_analyze_skill_performance_issue():
    ...
    metrics = {"models": {"by_model": {"sonnet": {"invocations": 10, "success_rate": 70.0}}}}
...
def test_analyze_quality_issue():
    ...
    analysis = {"trends": {"sessions": {"trend": "decreasing", "slope": -5.0}}}
    ...
    assert any(
        "critical" in c["cause"].lower() or "regression" in c["cause"].lower()
...
def test_analyze_anomaly_issue():
    ...
    issue = {
        ...
        "severity": "medium",
        "evidence": {
            "outliers": [{"date": "2026-04-03", "value": 100, "direction": "high"}],
            "trend_breaks": [{"date": "2026-04-05", "break_type": "reversal"}],
        },
    }
...
def test_recommendation_prioritization():
    ...
    insights = {
        "issues": [
            {"category": "quality", "severity": "critical", "recommended_action": "Critical fix"},
            {"category": "quality", "severity": "low", "recommended_action": "Minor improvement"},
        ],
        "opportunities": [],
        "risks": [],
    }
