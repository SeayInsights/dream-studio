...
def test_create_and_get_report():
    ...
    # Create report
    report_data = {"name": "Test Report 2", "type": "detailed", "days": 14}
...
def test_delete_report():
    ...
    # Create report first
    report_data = {"name": "Report to Delete", "type": "technical", "days": 7}
...
def test_create_export():
    ...
    export_data = {"format": "json", "include_charts": True, "include_raw_data": False}
