...
class TestReportScheduler:
    ...
    def scheduler(self, temp_db):
        ...
        from projections.core.scheduler.job_scheduler import ReportScheduler
    ...
    def test_job_execution(self, scheduler):
        ...
        job_id = scheduler.add_job(func=mock_job_func, trigger="interval", seconds=1, id="test_job")
...
class TestScheduleStorage:
    ...
    def test_update_schedule_in_storage(self, storage):
        ...
        # Update schedule
        updated_data = {"job_id": job_id, "name": "Updated", "recipients": ["updated@example.com"]}
