        ...
        "sections": [
            {
                ...
                "metrics": {"total_sessions": 127, "success_rate": 95.5, "avg_duration": 18.5},
                "charts": [
                    {
                        "type": "bar",
            ...
            {"title": "Token Usage", "metrics": {"total_tokens": 1500000, "cost_usd": 45.50}},
        ],
    }
        ...
        sample_report["sections"][0]["charts"] = [
            {
                ...
                "data": {"labels": ["Week 1", "Week 2", "Week 3"], "values": [100, 150, 200]},
            }
        ]
    ...
    def test_pdf_multipage(self, pdf_exporter, sample_report, temp_output_dir):
        ...
        for i in range(10):
            sample_report["sections"].append(
                {"title": f"Section {i+3}", "metrics": {"metric": i * 100}}
            )
...
class TestExcelExporter:
    ...
    def test_multisheet_export(self, excel_exporter, sample_report, temp_output_dir):
        ...
        from projections.exporters.excel_exporter import ExcelTemplateBuilder
...
class TestPPTXExporter:
    ...
    def pptx_exporter(self):
        ...
        from projections.exporters.pptx_exporter import PPTXExporter
    ...
    def test_pptx_templates(self, pptx_exporter, sample_report, temp_output_dir):
        ...
        try:
            success, path = pptx_exporter.export_to_pptx(
                sample_report, output_path, template=config.get("template")
            )
            assert success is True
        except Exception:
...
class TestCSVExporter:
    ...
    def csv_exporter(self):
        ...
        from projections.exporters.csv_exporter import CSVExporter
    ...
    def test_csv_delimiter_options(self, csv_exporter, sample_report, temp_output_dir):
        ...
        success, path = csv_exporter.export_to_csv(sample_report, output_path, delimiter=";")
...
class TestPowerBIExporter:
    ...
    def powerbi_exporter(self):
        ...
        from projections.exporters.powerbi_exporter import PowerBIExporter
