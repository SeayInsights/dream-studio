...
from projections.core.reports.generator import ReportGenerator
...
def mock_collectors():
    ...
    with (
        ...
        model.return_value.collect.return_value = {
            "total_requests": 450,
            "by_model": {"claude-sonnet-4.5": 300, "claude-haiku-4": 150},
        }
        ...
        workflow.return_value.collect.return_value = {"total_workflows": 67, "success_rate": 92.0}
...
class TestReportGenerator:
    ...
    def test_generate_custom_report(self, mock_collectors):
        ...
        report = generator.generate_report("custom", config={"template": custom_template})
    ...
    def test_invalid_date_range_format(self, mock_collectors):
        ...
        config = {"date_range": "not-a-valid-format"}
