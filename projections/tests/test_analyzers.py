...
from projections.core.analyzers.anomaly_detector import AnomalyDetector
from projections.core.analyzers.predictor import Predictor
...
def test_identify_growth_rate():
    ...
    timeline = [{"date": f"2026-04-{str(i+1).zfill(2)}", "count": 10 + i * 2} for i in range(14)]
...
def test_detect_trend_breaks():
    ...
    for i in range(15):
        ...
        timeline.append({"date": f"2026-04-{str(i+1).zfill(2)}", "count": count})
...
def test_detect_pattern_deviation():
    ...
    historical_data = [{"date": f"2026-03-{str(i+1).zfill(2)}", "count": 10 + i} for i in range(20)]

    current_data = [
        {"date": f"2026-04-{str(i+1).zfill(2)}", "count": 30 + i} for i in range(7)  # Much higher
    ]
...
def test_predict_next_value():
    ...
    timeline = [{"date": f"2026-04-{str(i+1).zfill(2)}", "count": 10 + i} for i in range(10)]
...
def test_calculate_forecast_accuracy():
    ...
    timeline = [{"date": f"2026-04-{str(i+1).zfill(2)}", "count": 10 + i} for i in range(21)]
