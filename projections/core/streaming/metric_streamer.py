...
class MetricStreamer:
    ...
    def __init__(
        ...
        logger.info(f"MetricStreamer initialized with {poll_interval}s poll interval")
    ...
    async def _collect_metrics(self) -> Dict[str, Any]:
        ...
        # Session metrics
        try:
            session_metrics = await loop.run_in_executor(None, self.session_collector.collect, 90)
        ...
        # Skill metrics
        try:
            skill_metrics = await loop.run_in_executor(None, self.skill_collector.collect, 90)
        ...
        # Token metrics
        try:
            token_metrics = await loop.run_in_executor(None, self.token_collector.collect, 90)
        ...
        # Model metrics
        try:
            model_metrics = await loop.run_in_executor(None, self.model_collector.collect, 90)
        ...
        # Lesson metrics
        try:
            lesson_metrics = await loop.run_in_executor(None, self.lesson_collector.collect, 90)
        ...
        # Workflow metrics
        try:
            workflow_metrics = await loop.run_in_executor(None, self.workflow_collector.collect, 90)
            ...
            results["workflows_avg_completion_time"] = workflow_metrics[
