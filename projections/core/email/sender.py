...
class EmailSender:
    ...
    def send_bulk(self, recipients: List[str], subject: str, body: str, html: bool = True) -> bool:
        """
    ...
    def send_alert(
        ...
        try:
            ...
            return self.send_email(to=recipients, subject=subject, body=html_body, html=True)
