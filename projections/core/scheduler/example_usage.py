...
def main():
    ...
    daily_job_id = scheduler.schedule_report(
        {
            ...
            "config": {"date_range": None},  # Last 30 days (default)
        }
    )
    ...
    print(
        "    To clear all jobs: [scheduler.delete_job(j['job_id']) for j in scheduler.list_jobs()]"
    )
                ...
                "template": {
                    "sections": [
                        ...
                        },
                        {
                            ...
                            "charts": [{"type": "bar", "title": "Skill Invocations"}],
                        },
                    ]
                },
            },
