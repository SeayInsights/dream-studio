...
class ReportGenerator:
    ...
    def generate_report(
        self, report_type: str, config: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
        ...
        metadata = {
            ...
            "date_range": {"start": date_range[0], "end": date_range[1], "days": days},
        }
    ...
    def _parse_date_range(self, date_range: Optional[Any]) -> Tuple[str, str]:
        """
