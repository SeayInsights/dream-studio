...
def test_basic_export():
    ...
    report_data = {
        ...
        "sections": [{"title": "Test Section", "metrics": {"Test Metric": 123}, "charts": []}],
    }
...
def test_chart_integration():
    ...
    from projections.exporters.chart_renderer import ChartRenderer
    ...
    chart_config = {
        ...
        "data": {
            ...
            "datasets": [{"label": "Revenue", "data": [25000, 30000, 28000, 35000]}],
        },
    }
...
def test_real_world_export():
    ...
    # Export to Downloads
    output_path = "C:/Users/Example User/Downloads/test_analytics_report.pptx"
