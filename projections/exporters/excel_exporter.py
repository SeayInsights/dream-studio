...
Example usage:
    ...
    result = exporter.export_to_excel(
        data=report_data,
        output_path="C:/Users/Example User/Downloads/analytics_report.xlsx"
    )
...
class ExcelExporter:
    ...
    def export_to_excel(self, data: Dict[str, Any], output_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if validation_error:
                return {"success": False, "error": f"Data validation failed: {validation_error}"}
            ...
            return {"success": True, "path": str(result_path), "library": self.library}
    ...
    def _export_xlsxwriter(self, data: Dict[str, Any], output_file: Path) -> Path:
        ...
        # Create sheets
        self._create_summary_sheet_xlsxwriter(
            workbook, data, header_format, bold_format, title_format
        )
    ...
    def _create_metrics_sheet_xlsxwriter(
        self, workbook: Any, data: Dict[str, Any], header_format: Any
    ) -> None:
        ...
        for metric_name, metric_value in metrics.items():
            ...
            worksheet.write(
                row, 3, str(metric_value) if isinstance(metric_value, (dict, list)) else ""
            )
            row += 1
...
def main():
    ...
    sample_data = {
        ...
        "insights": {
            "user_growth": {"description": "User base grew 15% over the quarter", "impact": "high"},
            "engagement": {"description": "Daily active users increased 8%", "impact": "medium"},
        },
        "recommendations": [
            {
    ...
    # Export report
    output_path = "C:/Users/Example User/Downloads/sample_analytics_report.xlsx"
