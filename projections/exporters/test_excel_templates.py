        ...
        "sections": [
            ...
            },
            {
                ...
                "metrics": {
                    ...
                    "outcomes": {"success": 120, "partial": 20, "failed": 5},
                },
            },
            {
                "title": "Model Usage",
            ...
            },
            {
                ...
                "metrics": {
                    "total_lessons": 12,
                    "by_source": {"build": 5, "debug": 4, "deploy": 2, "review": 1},
            ...
            },
            {
                ...
                "metrics": {
                    ...
                    "by_status": {"completed": 75, "failed": 8, "in_progress": 4},
                    "success_rate": 0.86,
            ...
            },
            {
                ...
                "metrics": {
                    "by_skill": {
                        "ds-core": {"invocations": 89, "success_rate": 0.95, "avg_duration": 8.5},
                        "ds-quality": {
                            "invocations": 67,
                            "success_rate": 0.92,
                            "avg_duration": 6.2,
                    ...
                    "failures": [
                        {"skill": "ds-security", "reason": "timeout", "timestamp": "2026-04-28"},
...
def create_historical_report_data(days: int = 30) -> dict:
    ...
    return {
        ...
        "sections": [
            ...
            {"title": "Token Usage", "metrics": {"daily_average": 33333}},
            {"title": "Session Analytics", "metrics": {"avg_duration_minutes": 50.0}},
            {"title": "Workflow Analytics", "metrics": {"success_rate": 0.82}},
        ],
    }
...
def test_summary_dashboard():
    ...
    try:
        ...
        # Save
        output_path = "C:/Users/Example User/Downloads/analytics_summary_dashboard.xlsx"
...
def test_raw_data_dump():
    ...
    try:
        ...
        # Save
        output_path = "C:/Users/Example User/Downloads/analytics_raw_data_dump.xlsx"
        result = exporter.save_workbook(wb, output_path)
...
def test_trend_analysis():
    ...
    try:
        ...
        # Save
        output_path = "C:/Users/Example User/Downloads/analytics_trend_analysis.xlsx"
        result = exporter.save_workbook(wb, output_path)
...
def test_comparison():
    ...
    try:
        ...
        # Save
        output_path = "C:/Users/Example User/Downloads/analytics_comparison.xlsx"
        result = exporter.save_workbook(wb, output_path)
...
def test_all_templates():
    ...
    try:
        ...
        # Save
        output_path = "C:/Users/Example User/Downloads/analytics_complete_report.xlsx"
        result = exporter.save_workbook(wb, output_path)
...
def main():
    ...
    print("Check C:/Users/Example User/Downloads/ for generated files")
    print("=" * 60)
