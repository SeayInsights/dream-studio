    ...
    return {
        ...
        "sections": [
            ...
            },
            {
                "title": "Token Usage",
                "metrics": {
                    "by_model": {"claude-sonnet-4-5": 3456789, "claude-haiku-4-0": 2222112},
            ...
            },
            {
                ...
                "metrics": {
                    ...
                    "outcomes": {"success": 140, "partial": 12, "failed": 4},
...
def test_integration():
    ...
    success, result = exporter.export_to_csv(report, output_dir / "integration_single.csv")
    ...
    success, result = exporter.export_multiple(report, output_dir / "multiple")
    ...
    # Test 3: ZIP archive
    print("   c) ZIP archive")
    success, result = exporter.export_as_zip(report, output_dir / "integration_archive.zip")
