...
from projections.exporters import ExcelExporter, ExcelTemplateBuilder
...
def example_weekly_dashboard():
    ...
    output_path = f"C:/Users/Example User/Downloads/weekly_dashboard_{timestamp}.xlsx"
...
def example_monthly_report():
    ...
    current_report = generator.generate_report(
        report_type="detailed",
        config={"date_range": (start_of_month.strftime("%Y-%m-%d"), today.strftime("%Y-%m-%d"))},
    )
    ...
    output_path = f"C:/Users/Example User/Downloads/monthly_report_{month_name}.xlsx"
...
def example_quarter_comparison():
    ...
    q1_report = generator.generate_report(
        report_type="detailed", config={"date_range": ("2026-01-01", "2026-03-31")}
    )

    # Q2 2026
    q2_report = generator.generate_report(
        report_type="detailed", config={"date_range": ("2026-04-01", "2026-06-30")}
    )
    ...
    # Save
    output_path = "C:/Users/Example User/Downloads/Q2_vs_Q1_2026.xlsx"
    result = exporter.save_workbook(wb, output_path)
...
def example_data_export_for_analysis():
    ...
    output_path = f"C:/Users/Example User/Downloads/analytics_data_export_{timestamp}.xlsx"
...
def example_custom_kpi_report():
    ...
    custom_template = {
        "sections": [
            {
                "title": "Cost Metrics",
                "metrics": ["tokens.total_cost_usd", "tokens.by_model", "tokens.daily_average"],
                "charts": [],
            },
            {
    ...
    report = generator.generate_report(
        report_type="custom",
        config={"date_range": ("2026-04-01", "2026-04-30"), "template": custom_template},
    )
    ...
    # Save
    output_path = "C:/Users/Example User/Downloads/custom_kpi_report.xlsx"
    result = exporter.save_workbook(wb, output_path)
    ...
    try:
        ...
        try:
            ...
            prev_report = generator.generate_report(
                report_type="detailed",
                config={
                    "date_range": (prev_start.strftime("%Y-%m-%d"), prev_end.strftime("%Y-%m-%d"))
                },
            )
        ...
        output_path = f"C:/Users/Example User/Downloads/weekly_report_W{week_num}_{year}.xlsx"
