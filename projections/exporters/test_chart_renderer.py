...
import tempfile
import shutil
from projections.exporters.chart_renderer import ChartRenderer, render_chart_fallback
...
class TestChartRenderer:
    ...
    def test_line_chart_basic(self, renderer, temp_dir):
        ...
        config = {
            ...
            "data": {
                ...
                "datasets": [{"label": "Revenue", "data": [10, 20, 15, 25, 30]}],
            },
        }
    ...
    def test_bar_chart_basic(self, renderer, temp_dir):
        ...
        config = {
            ...
            "data": {
                "labels": ["Q1", "Q2", "Q3", "Q4"],
                "datasets": [{"label": "Sales", "data": [100, 120, 110, 140]}],
            },
        }
    ...
    def test_scatter_chart_multi_series(self, renderer, temp_dir):
        ...
        config = {
            ...
            "data": {
                "datasets": [
                    {"label": "Team A", "data": [{"x": 1, "y": 10}, {"x": 2, "y": 15}]},
                    {"label": "Team B", "data": [{"x": 1, "y": 12}, {"x": 2, "y": 14}]},
                ]
            },
        }
    ...
    def test_svg_output(self, renderer, temp_dir):
        ...
        config = {
            "type": "line",
            "title": "Test SVG",
            "data": {"labels": ["A", "B", "C"], "datasets": [{"label": "Test", "data": [1, 2, 3]}]},
        }
    ...
    def test_missing_data(self, renderer, temp_dir):
        ...
        config = {"type": "line", "title": "Missing Data", "data": {}}
    ...
    def test_fallback_placeholder(self):
        ...
        config = {"type": "line", "title": "Revenue Chart"}
