...
import tempfile
from projections.exporters import ChartRenderer, render_chart_fallback
...
def demo_line_chart(renderer, output_dir):
    ...
    config = {
        ...
        "data": {
            ...
            "datasets": [
                {"label": "Product A", "data": [45, 52, 48, 65, 70, 68]},
                {"label": "Product B", "data": [30, 38, 42, 45, 50, 55]},
            ],
        },
    }
...
def demo_bar_chart(renderer, output_dir):
    ...
    config = {
        ...
        "data": {
            ...
            "datasets": [
                {"label": "Revenue", "data": [2.3, 2.8, 3.1, 3.5]},
                {"label": "Target", "data": [2.5, 2.7, 3.0, 3.2]},
            ],
        },
    }
