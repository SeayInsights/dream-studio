...
from projections.exporters import PPTXExporter, ChartRenderer
...
def create_executive_summary_report():
    ...
    revenue_chart_config = {
        ...
        "data": {
            ...
            "datasets": [{"label": "Revenue", "data": [95000, 110000, 105000, 125430.50]}],
        },
    }
    ...
    user_growth_config = {
        ...
        "data": {
            "labels": ["January", "February", "March", "April"],
            "datasets": [{"label": "Active Users", "data": [10500, 11200, 11800, 12458]}],
        },
    }
    ...
    region_chart_config = {
        ...
        "data": {
            ...
            "datasets": [{"data": [45000, 38000, 28000, 14430.50]}],
        },
    }
    ...
    report_data = {
        ...
        "sections": [
            ...
            # Section 3: User Growth
            {
                ...
                "charts": [
                    {"title": "Active User Trends", "type": "line", "image_path": user_growth_path}
                ],
            },
    ...
    output_path = "C:/Users/Example User/Downloads/executive_summary_report.pptx"
...
def create_custom_presentation():
    ...
    # Slide 1: Title
    exporter.add_title_slide(prs, "Q1 2026 Analytics Review", "Performance Highlights\nApril 2026")
    ...
    exporter.add_text_slide(
        prs,
        "Questions?",
        ["Thank you for your attention", "", "Analytics Team", "dream-studio Platform"],
    )

    # Save presentation
    output_path = "C:/Users/Example User/Downloads/custom_presentation.pptx"
