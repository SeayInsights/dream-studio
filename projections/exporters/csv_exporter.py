...
class CSVExporter:
    ...
    def _validate_data(self, data: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            validate_export_payload(data)
        except ExportPrivacyError as e:
            return str(e)
    ...
    def _export_section_to_csv(self, section: Dict[str, Any], file_path: Path) -> Tuple[bool, str]:
        """
    ...
    def _export_metadata_txt(self, metadata: Dict[str, Any], file_path: Path) -> Tuple[bool, str]:
        """
