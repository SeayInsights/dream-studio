...
Example usage:
    from projections.exporters.excel_exporter import ExcelExporter
    from projections.exporters.excel_templates import ExcelTemplateBuilder
    from projections.core.reports import ReportGenerator
    ...
    exporter.save_workbook(wb, "C:/Users/Example User/Downloads/dashboard.xlsx")
"""
...
class ExcelTemplateBuilder:
    ...
    def build_summary_dashboard(self, data: Dict[str, Any], workbook: openpyxl.Workbook) -> None:
    ...
    def build_raw_data_dump(self, data: Dict[str, Any], workbook: openpyxl.Workbook) -> None:
    ...
    def build_trend_analysis(self, data: Dict[str, Any], workbook: openpyxl.Workbook) -> None:
    ...
    def build_comparison(
        ...
        self._create_comparison_sheet(
            workbook, current_metrics, current_metadata, historical_metrics, historical_metadata
        )
    ...
    def _create_kpi_cards_sheet(
        self, workbook: openpyxl.Workbook, metrics: Dict[str, Any], metadata: Dict[str, Any]
    ) -> None:
        ...
        ws["A2"] = (
            f"Period: {date_range.get('start', 'N/A')} to {date_range.get('end', 'N/A')} ({date_range.get('days', 0)} days)"
        )
    ...
    def _create_charts_sheet(
        ...
        if by_model:
            row = self._add_pie_chart(ws, row, title="Token Distribution by Model", data=by_model)
        ...
        if day_of_week:
            row = self._add_bar_chart_from_dict(
                ws, row, title="Sessions by Day of Week", data=day_of_week
            )
    ...
    def _create_raw_data_sheet(
        self, workbook: openpyxl.Workbook, category_name: str, data: Dict[str, Any]
    ) -> None:
    ...
    def _create_trend_analysis_sheet(
        ...
        for col in ["A", "B", "C", "D"]:
            ...
            cell.fill = PatternFill(
                start_color=self.COLOR_HEADER, end_color=self.COLOR_HEADER, fill_type="solid"
            )
        ...
        trends = [
            ...
            (
                "Success Rate",
                f"{metrics.get('skills', {}).get('success_rate_overall', 0):.1%}",
                "→",
            ),
            (
                "Avg Session Duration",
                f"{metrics.get('sessions', {}).get('avg_duration_minutes', 0):.1f} min",
                "↓",
            ),
        ]
    ...
    def _create_comparison_sheet(
        ...
        ws[f"C{row}"] = (
            f"{historical_range.get('start', 'N/A')} to {historical_range.get('end', 'N/A')}"
            if historical_range
            else "N/A"
        )
        ...
        for metric_name, current_val, historical_val in comparisons:
            ...
            if (
                ...
                and isinstance(historical_val, (int, float))
            ):
    ...
    def _create_kpi_card(self, ws: Any, kpi: Dict[str, Any], row: int, col: int) -> None:
        ...
        value_cell.fill = PatternFill(
            start_color=kpi["color"], end_color=kpi["color"], fill_type="solid"
        )
    ...
    def _add_bar_chart_from_dict(self, ws: Any, row: int, title: str, data: Dict[str, int]) -> int:
    ...
    def _add_pie_chart(self, ws: Any, row: int, title: str, data: Dict[str, Any]) -> int:
    ...
    def _add_top_list_from_dict(
        self, ws: Any, row: int, title: str, headers: List[str], data: List[Tuple[str, Any]]
    ) -> int:
    ...
    def _add_lessons_list(self, ws: Any, row: int, lessons: List[Dict[str, Any]]) -> int:
    ...
    def _display_complex_data(self, ws: Any, row: int, data: Any) -> int:
...
def main():
    ...
    sample_report = {
        ...
        "sections": [
            ...
            },
            {
                ...
                "metrics": {
                    "top_skills": [
                        {"skill_name": "ds-core", "invocations": 89, "success_rate": 0.95},
                        {"skill_name": "ds-quality", "invocations": 67, "success_rate": 0.92},
            ...
            },
            {
                ...
                "metrics": {
                    "by_project": {"dream-studio": 78, "dreamysuite": 45, "analytics": 22},
                    "day_of_week": {
                        "Monday": 25,
                        "Tuesday": 30,
                        "Wednesday": 22,
            ...
            },
            {
                ...
                "metrics": {
                    ...
                    "recent_lessons": [
                        {
                            "lesson": "Always check for open PRs before pushing",
                            "source": "build",
                            "status": "active",
                        },
                        {
                            "lesson": "Use Glob after subagent writes",
                            "source": "debug",
                            "status": "active",
                        },
                    ],
    ...
    wb1.save("C:/Users/Example User/Downloads/demo_summary_dashboard.xlsx")
    ...
    wb2.save("C:/Users/Example User/Downloads/demo_raw_data_dump.xlsx")
    ...
    wb3.save("C:/Users/Example User/Downloads/demo_trend_analysis.xlsx")
    ...
    historical_report = {
        ...
        "sections": [
            ...
            {"title": "Top Skills", "metrics": {"success_rate_overall": 0.90}},
            {"title": "Session Analytics", "metrics": {"avg_duration_minutes": 50.0}},
        ],
    }

    builder.build_comparison(sample_report, wb4, historical_report)
    wb4.save("C:/Users/Example User/Downloads/demo_comparison.xlsx")
    print("  Saved: demo_comparison.xlsx")

    print("\nAll demo templates created successfully!")
    print("Check C:/Users/Example User/Downloads/ for the files.")
