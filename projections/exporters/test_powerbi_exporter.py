        ...
        "sections": [
            {
                ...
                "metrics": {
                    ...
                    "top_skills": [
                        {"name": "ds-core", "count": 50, "success_rate": 0.96},
                        {"name": "ds-quality", "count": 40, "success_rate": 0.94},
                        {"name": "ds-domains", "count": 30, "success_rate": 0.93},
                    ],
                },
            },
            {
...
def test_build_skills_table(sample_report_data):
    ...
    exporter = PowerBIExporter()
    section_data = {
        section["title"]: section.get("metrics", {}) for section in sample_report_data["sections"]
    }
    ...
    assert table["rows"][0]["skill_name"] == "ds-core"
...
def test_build_date_table():
    ...
    exporter = PowerBIExporter()
    date_range = {"start": "2026-04-01", "end": "2026-04-05", "days": 5}
...
def test_generate_readme(sample_report_data):
    ...
    csv_files = ["/path/to/skills.csv", "/path/to/tokens.csv"]
