...
**Input**: Design documents from `.planning/specs/[topic-name]/`
...
- **dream-studio skills**: `skills/[skill-name]/`
- **domain docs**: `skills/domains/[domain-name]/`
- **Web app**: `src/`, `tests/`
...
<!-- 
  ...
  ds-core plan MUST replace these with actual tasks based on:
...
- [ ] TXXX Validation against acceptance criteria
...
**Execution via**: `ds-core build` skill
