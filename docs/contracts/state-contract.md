...
Projection code must not write canonical operational tables such as `raw_sessions`, `raw_workflow_runs`, `execution_nodes`, `decision_log`, `memory_entries`, `activity_log`, `hook_executions`, `adapter_executions`, or `canonical_events`.
