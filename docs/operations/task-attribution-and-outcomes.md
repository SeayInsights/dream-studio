...
<!-- 2026-06-06: Wave 6 — 13 verified-dead tables dropped (migration 101). shared-intelligence API surface source_tables lists no longer name dropped tables; attribution schema unchanged. No semantic change required. -->
