"""Tests for control/execution/models/selector.py — get_model_for_skill() frontmatter lookup."""
...
from control.execution.models.selector import (  # noqa: E402
    get_model_for_skill,
    _read_model_tier,
    _resolve_skill_md,
)
...
class TestGetModelForSkill:
    ...
    def test_opus_skill_multi(self) -> None:
        assert get_model_for_skill("ds-analyze multi") == "opus"

    def test_opus_skill_comply(self) -> None:
        assert get_model_for_skill("ds-security comply") == "opus"
    ...
    def test_haiku_skill_recap(self) -> None:
        assert get_model_for_skill("ds-core recap") == "haiku"

    def test_haiku_skill_coach(self) -> None:
        assert get_model_for_skill("ds-quality coach") == "haiku"

    def test_haiku_skill_jit(self) -> None:
        assert get_model_for_skill("ds-setup jit") == "haiku"

    def test_haiku_skill_handoff(self) -> None:
        assert get_model_for_skill("ds-core handoff") == "haiku"

    def test_sonnet_skill_build(self) -> None:
        assert get_model_for_skill("ds-core build") == "sonnet"

    def test_sonnet_skill_debug(self) -> None:
        assert get_model_for_skill("ds-quality debug") == "sonnet"

    def test_sonnet_skill_plan(self) -> None:
        assert get_model_for_skill("ds-core plan") == "sonnet"

    def test_sonnet_skill_review(self) -> None:
        assert get_model_for_skill("ds-core review") == "sonnet"
...
class TestResolveSkillMd:
    ...
    def test_full_specifier(self) -> None:
        result = _resolve_skill_md("ds-core think")
