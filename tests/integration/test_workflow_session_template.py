...
from control.execution.workflow.engine import resolve_templates  # noqa: E402


@pytest.fixture(autouse=True)
def disable_session_cache_event_bridge(monkeypatch: pytest.MonkeyPatch) -> None:
    """Template resolution tests should not emit events to the native runtime DB."""
    from control.session import cache

    monkeypatch.setattr(cache, "_get_bridge", lambda: None)
