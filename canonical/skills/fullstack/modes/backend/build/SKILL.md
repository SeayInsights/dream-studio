...
|---|---|---|
| `wrangler.toml` | Cloudflare Workers | Delegate entirely to `apps:saas-build` |
...
DO delegate entirely to `apps:saas-build` for Cloudflare Workers — do not duplicate its patterns here.
