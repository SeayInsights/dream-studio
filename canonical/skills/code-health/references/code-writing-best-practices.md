...
**Status:** Active reference for ds-code-health:code-quality skill (18.4.3)
...
**Status: Source content preserved for future use. NOT implemented as rules in this skill (18.4.3).** The future ds-code-health:testing skill (18.5.1) will implement testing rules. When 18.5.1 begins, it runs a pre-flight check to decide which Section G rules to implement. No rules from Section G appear in code-quality's rules.yml.
...
The rest of section M (formatter automation, linter automation, pre-commit hooks, CI gates, dependency scanning) is deferred to ds-release:ops (18.6.3).
