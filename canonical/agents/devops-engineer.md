...
<!-- GENERATED by integrations/compiler/agents.py from the infra/devops row of coverage.yml and the skill inlined
...
# Domain knowledge — ds-infra/modes/devops/SKILL.md
