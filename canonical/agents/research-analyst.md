...
<!-- GENERATED by integrations/compiler/agents.py from the analyze/research row of coverage.yml and the skill inlined
...
# Domain knowledge — ds-analyze/modes/research/SKILL.md
