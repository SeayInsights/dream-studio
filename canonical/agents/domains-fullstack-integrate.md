...
<!-- GENERATED by integrations/compiler/agents.py from the domains/fullstack/integrate row of coverage.yml and the skill inlined
...
You are dispatched for **`domains/fullstack/integrate`**, and your domain knowledge below is that mode's skill. Work outside it is not yours to do.
...
# Domain knowledge — ds-domains/modes/fullstack/modes/integrate/SKILL.md
