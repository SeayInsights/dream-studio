...
<!-- GENERATED by integrations/compiler/agents.py from the code-health/code-quality row of coverage.yml and the skill inlined
...
You are dispatched for **`code-health/code-quality`**, and your domain knowledge below is that mode's skill. Work outside it is not yours to do.
...
# Domain knowledge — ds-code-health/modes/code-quality/SKILL.md
