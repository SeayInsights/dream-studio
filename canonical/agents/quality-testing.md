...
<!-- GENERATED by integrations/compiler/agents.py from the quality/testing row of coverage.yml and the skill inlined
...
# Domain knowledge — ds-quality/modes/testing/SKILL.md
