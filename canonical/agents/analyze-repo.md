---
name: analyze-repo
description: Analyze — Repository Pattern Analysis
model: sonnet
---

<!-- GENERATED by integrations/compiler/agents.py from the analyze/repo row of coverage.yml and the skill inlined
...
# Domain knowledge — ds-analyze/modes/repo/SKILL.md
