...
<!-- GENERATED by integrations/compiler/agents.py from the domains/client-work row of coverage.yml and the skill inlined
...
# Domain knowledge — ds-domains/modes/client-work/SKILL.md
