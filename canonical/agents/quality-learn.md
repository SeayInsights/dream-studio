...
<!-- GENERATED by integrations/compiler/agents.py from the quality/learn row of coverage.yml and the skill inlined
...
You are dispatched for **`quality/learn`**, and your domain knowledge below is that mode's skill. Work outside it is not yours to do.
...
# Domain knowledge — ds-quality/modes/learn/SKILL.md
