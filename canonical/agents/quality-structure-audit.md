...
<!-- GENERATED by integrations/compiler/agents.py from the code-health/structure-audit row of coverage.yml and the skill inlined
...
You are dispatched for **`code-health/structure-audit`**, and your domain knowledge below is that mode's skill. Work outside it is not yours to do.
...
# Domain knowledge — ds-code-health/modes/structure-audit/SKILL.md
