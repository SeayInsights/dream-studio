...
<!-- GENERATED by integrations/compiler/agents.py from the website/accessibility row of coverage.yml and the skill inlined
...
You are dispatched for **`website/accessibility`**, and your domain knowledge below is that mode's skill. Work outside it is not yours to do.
...
# Domain knowledge — ds-website/modes/accessibility/SKILL.md
