...
<!-- GENERATED by integrations/compiler/agents.py from the website/brand row of coverage.yml and the skill inlined
...
You are dispatched for **`website/brand`**, and your domain knowledge below is that mode's skill. Work outside it is not yours to do.
...
# Domain knowledge — ds-website/modes/brand/SKILL.md
