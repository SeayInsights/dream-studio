...
def main() -> int:
    ...
    """
    parser = argparse.ArgumentParser(description="Check analyzed repos for updates")
    parser.add_argument(
    ...
    # Query repos to check (read-only)
    try:
        ...
        for update in updates_found:
            ...
            if (
                ...
                try:
                    ...
                    print(
                        f"    Re-analysis complete: {result['patterns_count']} patterns, {result['building_blocks_count']} blocks"
                    )
                except Exception as e:
