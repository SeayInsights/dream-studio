...
Classification: local-only optional security/client tooling. This script
creates local files only when an operator runs it directly; it is not
canonical org aggregation, cloud sync, or core runtime authority.
