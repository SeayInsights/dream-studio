...
- Reference material belongs in generated/local authority stores, not in repo-root historical folders.
...
| `docs/` | Current public/operator documentation only; historical reference packs stay outside the repo |
