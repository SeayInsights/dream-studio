...
- [ ] Decision table in first 20 lines?
- [ ] Zero scaffolding phrases? (Search: "this section", "refer to", "following")
- [ ] 50%+ rules in DO/DON'T format?
- [ ] Main SKILL.md <300 lines?
- [ ] All headings have `{#anchor}` IDs?
- [ ] Content ordered by access frequency?
