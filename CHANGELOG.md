...
### Features
- **release:** track the synthesized dist/plugin artifact + real projection guards (WO 90a13043) (#596)
- **release:** synthesized plugin artifact for github-source marketplace install (WO 90a13043) (#595)
- **release:** wire semver VERSION bump + manifest regen into release flow (WO 18bcaea6) (#594)
- **release:** public marketplace source + semver versioning (WO-REL-PACKAGING) (#592)
- **prd:** dashboard PRD+SOW panel read-model + route (WO P5) (#587)
- **prd:** ds prd CLI + milestone-close auto-refresh (WO P4) (#586)
- **prd:** PRD+SOW rescore engine + evidence harvesters (WO P3) (#585)
- **gates:** executable_ac accepts an operator attestation for design-only WOs (WO 254674de) (#584)
- **skills:** silent-default / fail-quiet review lens from Fulcrum ADR-004 (WO 7fcfe88a / R6) (#578)
- **verify:** re-runnable scope-constrained verification protocols (WO R7) (#577)
- **security:** automated secret-scan baseline + native scanner + single-source pins (WO 7e1958ae / R4) (#576)
- **gates:** change-impact affirmation + revert guard + native release automation (WO 336b9502 / R5) (#575)
- **gates:** ratified-contract gate — normative pre-implementation specs (WO cd043da8 / R2) (#574)
- **adr:** durable architecture decision records + ds-core wiring (WO f9c5c142 / R1) (#573)
- **migrations:** paired rollbacks — reversible authority migrations gate (WO 88321152) (#572)
- **analytics:** backfill historical pulse-*.md bodies into report_body (WO 35cb2edb) (#566)
- **escalation,pulse:** drop the ESC/pulse disk writes — authority is the sole record (WO-FILESDB-C4B S5) (#565)
- **pulse:** capture the full pulse report body in the authority (WO-FILESDB-C4B S4) (#563)
- **pulse:** open-escalation count reads the authority store, not a disk glob (WO-FILESDB-C4B S3) (#562)
- **gates:** executable-check gate verifies the WO's target repo, not always Dream Studio (WO 2c751184) (#561)
- **escalation:** ds escalation list/status/resolve operator surface (WO-FILESDB-C4B S2) (#560)
- **escalation:** dual-write escalations to the authority artifact store (WO-FILESDB-C4B S1) (#559)
- **enforce:** deny .planning disk writes — zero-disk docstore-only (WO-FILESDB-P3 S4a) (#555)
- **memory-ingest:** read GOTCHAS.md from the docstore, disk-fallback (WO-FILESDB-P3 S3b-3) (#554)
- **milestones:** read gate artifacts from the docstore, disk-fallback (WO-FILESDB-P3 S3b-2) (#553)
- **filesdb:** ds_files.work_order_id soft reference — relate docs to work orders (WO-FILESDB-P3 S3b-1) (#552)
- **filesdb:** ds files write/read — author & read notes in the docstore, no disk (WO-FILESDB-P3 S3a) (#551)
- **filesdb:** planning category + idempotent .planning->files.db backfill (WO-FILESDB-P3 S1+S2) (#550)
- **brownfield:** offer-gated audit run + fold findings into readiness report/stabilization scope (WO-BROWNFIELD-OFFER-INVOKE) (#523)
- **brownfield:** adaptive routing — detected stack -> relevant ds-quality modes (WO-BROWNFIELD-ADAPTIVE) (#522)
- **filesdb:** packet reports/results/rendered packets -> packet store (WO-FILESDB-C5) (#519)
- **filesdb:** packet-system decisions -> authority-free packet store (WO-FILESDB-C4) (#518)
- **filesdb:** packet-system evals -> authority-free packet store (WO-FILESDB-C3) (#517)
- **filesdb:** WO ceremony artifacts -> authority (context + review-verdict, WO-FILESDB-C2) (#515)
- **filesdb:** artifact-store foundation — instance_key + extended kinds + read surface (WO-FILESDB-C1, mig 152) (#514)
- **hooks:** log execution of the two directly-wired enforce hooks (WO d1150c16) (#511)
- **auto-activation:** skill-description frontmatter + UserPromptSubmit router (WO-AUTOACT-A/B) (#506)
- **filesdb:** move active_skill/active_task/platform runtime-state JSON into the authority (WO-FILESDB-P2 task 2) (#498)
- **telemetry:** capture validation results from the executable-check runner (WO-VALIDATION-CAPTURE) (#497)
- **telemetry:** capture agent identity from subagent (Task) invocations (WO-AGENT-TELEMETRY) (#496)
- **telemetry:** log every dispatched hook execution, not just on-pulse (WO-HOOK-EXEC-STATS) (#495)
- **dashboard:** repoint workflow + validation component reads to DuckDB events_fact (WO-DASH-DUCKDB-PROJECTION) (#494)
- **filesdb:** per-session token accumulator in the authority (WO-FILESDB-P2 task 1) (#492)
- **filesdb:** verify mirrors review_verdict to authority + .planning backfill (WO-FILESDB-P1) (#491)
- **filesdb:** WO ceremony artifacts in the authority (WO-FILESDB-P1) (#490)
- **analytics:** harden the native DuckDB store — reject wrong-format files loudly (e2566ad5) (#466)
- **gates:** tombstone guard — dropped tables can never resurface (e5b24ab1) (#455)
- **gates:** blocking pin-tests step in the pre-push workflow (3c71fc1b) (#454)
- **analytics:** token view derives model/cache/cost from ai-canonical payloads (8bc3731b) (#450)
- **collectors:** SessionCollector on the DuckDB raw_sessions view (e51389d3) (#449)
- **schema:** event-ify eval+decision — verify columns + canonical events + backfill (fcd8cf14) (#445)
- **schema:** Wave 1 substrate drop — 5 aspirational telemetry tables (migration 130) (#434)
- **db-realignment:** DuckDB events_fact read surface + leanness gate (foundation) (#417)
- **cli:** extract system commands from ds.py into commands/system.py (#413)
- **marketplace:** Claude plugin manifest + namespaced skill IDs + dual-distribution parity (WO-P20-MARKETPLACE) (#406)
- **integrate:** per-tool AGENTS.md targets for Codex/Gemini/Windsurf/Aider/Cursor (WO-P20-TOOL-TARGETS) (#405)
- **adapters:** generate AGENTS.md as universal target; CLAUDE.md imports it (WO-P20-AGENTS-GEN) (#404)
- **dashboard:** make evals/config/memory surfaces actionable (WO-DASH-ACTIONABILITY) (#403)
- **telemetry:** recover model_id from session transcript at capture (WO-CAPTURE-COMPLETENESS) (#402)
- **gate:** dashboard-truth live-authority gate + SQL-CHECK zero-row fail (WO-LIVE-DATA-GATE) (#401)
- **attribution:** project-name breakouts + token→skill capture; honest diagnoses (WO-DASH-ATTRIBUTION-SURFACES) (#399)
- **skills:** derive per-invocation execution duration (read-only) (WO-CAPTURE-SKILL-DURATION) (#398)
- **dashboard:** ds dashboard --restart/stop/--reload + stale-server warning (WO-DASH-RESTART) (#394)
- **dashboard:** API-equivalent cost + plan-vs-API panel (WO-DASH-COST-PLAN) (#389)
- **restore:** mutating `ds restore <backup>` with pre-restore safety backup (#385)
- **uninstall:** mutating `ds uninstall` with tiered teardown and state purge (WO-UNINSTALL) (#382)
- **escalation:** Opus retry, mandatory review, retry cap (WO-ESCALATION-LADDER) (#379)
- **work-orders:** block close on undone tasks — no 0/N closes (WO-TASKS-DONE-ENFORCE) (#378)
- **eval:** outcome eval — re-run closed-WO symptoms, auto-reopen on regress (WO-OUTCOME-EVAL) (#373)
- **gates:** blast-radius merge gate — dependent tests + nothing-left-hanging detectors (WO-BLAST-RADIUS-GATE) (#371)
- **verify:** reliable grader via DB identity; unreviewable no longer certifies (WO-REVIEW-TRACEABILITY) (#366)
- **close:** executable acceptance-criteria gate (WO-AC-EXECUTABLE) (#364)
- **token-capture:** project token.consumed on the live tick path (WO-TOKEN-BACKFILL) (#362)
- **sdlc:** originating symptom on work orders — close blocked until fix confirmed (#358)
- **files:** wire handoff/recap producers to files.db blob store (WO-FILESDB-WIRE) (#357)
- **token-capture:** wire PostToolUse hook and project token.consumed into token_usage_records (#354)
- **files:** wire handoff/recap producers to files.db blob store (WO-FILESDB-WIRE) (#353)
- **lessons:** migrate lesson storage from file .md to raw_lessons DB (WO-LESSONS-DB-UNIFY) (#352)
- **dashboard:** remove dead surfaces, add Dev section, align to v2 (WO-DASH-FRONTEND f0ffa6c5) (#347)
- **dashboard:** add ds_config panel and fix design-brief mutation writes (WO-DASH-CONFIG 99da1081) (#346)
- **dashboard:** add eval registry route and Eval Health panel (#345)
- **config:** add ds_config table and ds config set/show CLI (WO-FRICTION-CONFIG) (#338)
- **verify:** add SQL-CHECK executor to completion grader (WO-AUTHORITY-GRADER) (#337)
- **test:** 15-test suite for fixture resurrection guard + verify str/Path fix (#327)
- **guardrails:** wire rubric guardrail into PostToolUse pipeline + is_operator exemption (WO b57c60eb) (#309)
- **guardrails:** runtime rubric-immutability-constraint deny rule (WO 58890751) (#308)
- **eval:** add delta_from_fixture_baseline and failure_reasons to ds eval run --live output (WO c4c8d9aa) (#304)
- **pulse:** degrade health to DEGRADED when full-ci is red on main (#301)
- **ci-gate:** add failing_tests list to JSON verdict for test check (#300)
- **eval:** add pending_rerun schema column and wire friction/queue clear (WO 9a6222ca) (#297)
- **eval:** DREAM_STUDIO_FRICTION_THRESHOLD env var for operator-level threshold config (#294)
- **eval:** friction-to-eval feedback loop — rubric gate + queue + pulse (WO-EVAL-LOOP) (#292)
- **eval:** live-session eval mode + ds eval run --live (WO-EVAL-LIVE) (#290)
- **eval:** unified eval registry + hook eval telemetry (WO-EVAL-REGISTRY) (#288)
- **coupling:** deterministic engine→skill coupling gate + behavioral AC check (#275)
- require authority registration for out-of-scope findings (WO-FINDING-TRACK) (#270)
- continuous WO execution + todo mirroring + wave-based tasks (WO-TASK-UX) (#266)
- **verify:** parallel multi-grader WO verification + acceptance_criteria field (#260)
- **gates:** enforce dependency rules 1-4 with grep-level checks (#255)
- **routing:** surface next WO on close; add sequence-order warning on start (#256)
- **verify:** add ds work-order verify + independent_review close gate (WO-REVIEW-GATE) (#249)
- **cli:** --verbose tasks, --debug flag, task list alias, stale-db doctor check, remove tasks.md from plan skill (#248)
- **setup:** safe install/uninstall with DS namespace and projection health check (#247)

### Fixes
- **release:** install deps in release workflow before changelog.py --apply (WO-REL-FLOW-DEPS) (#602)
- **release:** exclude bytecode/cruft from the synthesized plugin artifact (WO 90a13043) (#597)
- **ci:** assert prd-sow wiring via app.openapi() not app.routes (#590)
- **ci:** green the full-ci release baseline (WO-REL-CI-BASELINE) (#589)
- **gates:** unify the control/analysis credential patterns into the single source (WO d84efdc4) (#583)
- **repo:** remove operator-local paths & decouple from the Fulcrum repo (WO c5c2b016) (#582)
- **gates:** unify credential-detection patterns into one source (WO ed3aa5db) (#581)
- **gates:** activate migration 154 so change_impact_affirmed is satisfiable (WO 6a1722d9) (#580)
- **dashboard:** route derived-store refresh through the runner, not a CLI write conn (WO deb9ccb3) (#579)
- **analytics:** read path must not fabricate an empty DuckDB store (WO 76d0744e) (#571)
- **work-orders:** treat deleted WOs as terminal across start/sequence/close-signal preconditions (WO 67a1efb7) (#570)
- **verify:** repo-aware + originating-WO traceability + no gap-spawn cascade + operator-attest (WO cef6ddaa) (#569)
- **milestone:** treat deleted work orders as terminal in the close precondition (WO 05fc434d) (#568)
- **dashboard-smoke:** build analytics schema before serving hook endpoints (WO d9ad3993) (#549)
- **tests:** read whole module surface in god-file source-contract checks (WO 8f032522) (#548)
- **tests:** repoint workflow state source-reads at the whole module (WO d807407c) (#547)
- **milestone:** treat cancelled work orders as terminal in milestone-close (WO 33f378df) (#546)
- **work_orders:** track the 9 verify_*.py siblings swallowed by .gitignore (WO 17061145) (#537)
- **gate:** make blast-radius unowned_table_write relocation-aware (WO 3a8073ee) (#535)
- recover full-ci on main — FILESDB stale tests + 2 real bugs + accepted-CVE suppression (#531)
- **gate:** reach reviewed-no-change from the blocking docs-drift lane (WO-DOCS-DRIFT-REVIEWED-ESCAPE) (#529)
- **workorder:** make close report-only — kill the auto-start pile-up (WO-CLOSE-REPORT-ONLY 34e79ccb) (#527)
- **doctor:** add hook-projection freshness check (WO 46fe128b) (#525)
- **doctor:** correct skill-sync false positives (WO-DOCTOR-DRIFT a4b3e21d) (#524)
- **deps:** floor click>=8.3.3 + mcp>=1.28.1 past pip-audit CVEs (WO 7f9085e7) (#512)
- **telemetry:** stamp explicit model sentinel so token events never record NULL model_id (#509)
- brownfield detection + project-registration hardening (3 WOs) (#508)
- **skills:** install frontmatter on existing installs + drop duplicated display name (#507)
- **gate:** scope dashboard_truth token invariants to attributed usage (#505)
- **projection:** register DesignBriefProjection in sync_tick (#504)
- **projection:** materialize work_order_type from work_order.created payload (#503)
- **readiness:** wire production-readiness dashboard to the readiness_events spine (WO-SCHEMALEAN) (#499)
- **dashboard:** keep derived metrics fresh — rebuild-on-open, events_fact anti-join, no-cache (WO-DASH-FRESHNESS) (#493)
- **ingestor:** populate ai_canonical_events.model_id from payload.model (WO-TOKEN-MODEL-CAPTURE) (#489)
- **telemetry:** capture model on token.consumption.recorded so dashboard cost is derivable (#488)
- **dashboard:** analytics trends+performance 500 on VARCHAR session timestamps (#487)
- **dashboard:** add /static assets to smoke-harness SMOKE_ENDPOINTS (fe3007fc) (#484)
- **schema-coherence:** exclude gates/sql_comments.py from DDL staleness scan (f1037037) (#476)
- **gates:** strip SQL/Python comments before DDL-keyword parsing (f1037037) (#475)
- **verify:** retry graders on non-JSON output, not only empty output (ae2be823) (#474)
- **verify:** dedup generic advisory gaps project-wide, not per reviewed WO (a4d66ef7) (#473)
- **gates:** bracket-aware param split in blast-radius signature detector (cd5308b7) (#471)
- **verify:** handle missing claude CLI at grader spawn, not a main-flow gate (4174d0e9) (#469)
- **verify:** guard grader availability and escalated-WO recert (4174d0e9) (#468)
- **verify:** independent_review certifies from authority+diff, not commit grep (4174d0e9) (#467)
- **schema:** migration 143 — rebuild tables with stale FK clauses to dropped tables (57bc41bc) (#465)
- **ci:** inline deleted migrations in 7 phase-19x tests + unit-collection gate (dce86173) (#463)
- **telemetry:** boundary-test comment substring + pin the boundary greps (d033e6f8) (#461)
- **workflow:** canonical event emission restored; drop write-orphaned raw tables — migration 141 (9f47a1a0) (#460)
- **telemetry:** shared spine ownership for derive-only modules; pin the contract tests (667d04e9) (#458)
- **schema:** guard dangling views around the migration-137 rebuild (dfddba19) (#453)
- **ci:** add token_model_pricing to the DuckDB schema pin (519336c0) (#451)
- **eval:** review-quality fixes — logged registry failures, contract guard, query hygiene, decision read-path tests (fcd8cf14) (#448)
- **ci:** align contract tests + generated artifacts with enforcement hooks (79f56243) (#444)
- **aggregate_metrics:** remove guard_events references dropped in migration 133 (#439)
- **ci:** remove obsolete TestActivityIdNullable (hook_executions+hook_findings dropped in 129/131) (#435)
- **ci:** obsolete ds_documents full-migration tests -> assert cluster dropped (#431)
- **three-store:** move ds_documents from studio.db to files.db (#430)
- **tests:** anchor hardcoded data timestamps relative to now (#429)
- **ci:** stop main red from time-bomb test dates + DuckDB DDL false-positive (#428)
- **work-orders:** preflight/audit gates read the WO's resolved db_path (#422)
- **tests:** restore sys.stdin between tests to stop order-dependent flake (#421)
- **analysis:** repoint repo_analyzer DocumentStore import to core.storage (WO 88949ce5) (#420)
- **gates:** force utf-8 on ds work-order verify subprocess I/O (WO a48ec9a2) (#419)
- **verify:** stop spawning duplicate remediation WOs against phantom targets (#415)
- **cli:** restore ds.py symbols broken by system-command split (#414)
- **tests:** check processed/ alongside spool/ for close-event assertions (#412)
- **close:** auto-flush projection after work-order and milestone close (WO-P20-CLOSE-LAG) (#409)
- **adapters:** restore full-ci green after Phase 20 adapter-file changes (WO-P20-FULLCI-FIX) (#407)
- **handoff:** stop auto-handoff from drafting empty-body lessons (WO-HANDOFF-LESSON-NOISE) (#400)
- **attribution:** key execution_events to project UUID, not free-text names (WO-ATTRIBUTION-NORMALIZE) (#397)
- **efficiency:** route cost through the shared pricing table (gap from WO-COST-MODEL-RATES) (#395)
- **pricing:** add claude-opus-4-8 rates — unstick API-equivalent cost (WO-COST-MODEL-RATES) (#393)
- **dashboard:** move Telemetry Traceability below the primary graphs (WO-DASH-OVERVIEW-ORDER) (#392)
- **dashboard:** repair analytics tabs — outcomes, empty-states, attribution breakouts (WO-DASH-ANALYTICS-TABS) (#391)
- **evals:** /api/v1/evals/health queried non-existent baseline columns (WO-EVALS-RENDER) (#390)
- **test:** retarget invisible-tables test to the Developer Diagnostics tab (#388)
- **dashboard:** consolidate developer diagnostics into one tab (WO-DASH-DEVDIAG-CONSOLIDATE) (#387)
- **dashboard:** render data-backed tabs, honest empty-states (WO-DASH-RENDER-FIX) (#386)
- **hardening:** path containment, graceful escalation error, studio_db conn-leak sweep (WO-GATE-HARDEN-CLEANUP) (#384)
- **context:** scale handoff/compact thresholds to active context window (WO-CONTEXT-THRESHOLD-SCALE) (#381)
- **work-orders:** close advertises the same next WO it auto-starts (WO-CLOSE-AUTOSTART-PARITY) (#380)
- **eval:** reopen regressed WOs via mutation layer (de04c240) (#376)
- **gates:** blast-radius detectors no longer over-fire (WO-BLAST-FALSEPOS) (#375)
- **schema-audit:** exclude hanging_detectors.py SQL-pattern prose (WO-SCHEMA-EXCLUDE) (#372)
- **tests:** scan whole spool tree in task-completed event test (WO-TASKDONE-FULLCI) (#370)
- **work-orders:** mark_task_done syncs the read model (WO-TASKDONE-SYNC) (#369)
- **tests:** invert unreviewable-gate test for WO-REVIEW-TRACEABILITY (#367)
- **tests:** seed executable ACs on close-tests for the always-on AC gate (WO-AC-EXECUTABLE) (#365)
- **token-capture:** wire on-post-tool-use into canonical dispatch (WO-CI-RED-RECOVERY) (#361)
- **ci:** load dispatch hooks by path in routing tests (WO-CI-RED-RECOVERY) (#360)
- **ci:** recover main from post-merge red (WO-CI-RED-RECOVERY) (#359)
- **telemetry+projects+dashboard:** address four dashboard validation gaps (WO-DASH-VALIDATION-GAPS) (#356)
- **design-brief:** make create/update/set_design_system emit-only (WO-DESIGNBRIEF-SIBLINGS) (#355)
- **design-briefs:** remove direct UPDATE from lock_design_brief() (WO-CI-DESIGNBRIEF) (#351)
- **dashboard:** fall back to ai_canonical_events for token metrics when token_usage_records empty (WO-TOKEN-PIPELINE) (#349)
- **dashboard:** repoint read-models at live data sources (WO-READMODEL-WIRING) (#348)
- **ci:** use dynamic timestamp in alert analytics test fixture (#344)
- **tests:** restore ds_work_orders seed in migration-061 replay test (#343)
- **verify:** treat empty grader LLM output as unreviewable, not close-blocker (#341)
- **tests:** remove dead-table DDL from pre-existing test fixtures (WO-FIXTURE-SWEEP) (#340)
- **ci:** remove duplicate test run from full-ci.yml, bump timeout to 60m (#336)
- **ci:** use dynamic timestamp in token metrics test fixture (WO 251b6966) (#335)
- **ci:** remove idea-validation from domains modes, skip slug test on CI (WO 20ead828) (#334)
- **ci:** delete dead-route tests, correct pl-009 assertion, exclude false-positive schema scan files (WO 20ead828) (#333)
- **tests:** restore security spine tests against findings_current_status + security_events (#328)
- **full-ci:** delete 10 dead-table tests — findings + hook_invocations dropped (#326)
- **migration-replay:** drop ghost views before RENAME + partial-fixture handler + resurrection gate (#325)
- **full-ci:** update capability validator to current EvalCase/EvalResult API (#324)
- **full-ci:** add acceptance_criteria to task_projection test DDL + ta0c design note (#323)
- **full-ci:** exclude DuckDB projections from SQLite boundary scan + update fixture docstring (#322)
- **full-ci:** canonical_events view conflicts + stale boundary write lists (#321)
- correct 8 full-CI test failures from post-migration-112 schema drift (#320)
- update stale table refs in telemetry tests after migrations 106/112 (#319)
- **cli:** print next_block to stderr so work-order close stdout is pure JSON (WO 8cc3ddac) (#318)
- **audit:** correct pl-009 test assertion for tagless repo (WO 919a9055) (#314)
- **verify:** deduplicate gap WO spawning in _insert_gap_work_orders (WO-SPAWN-DEDUPE) (#311)
- **eval-runner:** check subprocess returncode in _run_case_live to surface failed claude invocations (WO 312dc5ac) (#307)
- **telemetry:** log skipped DB writes in record_invocation instead of silent pass (WO 68fe6a1b) (#302)
- **eval:** queue show/run filter on pending_rerun + verify template contracts (#299)
- **eval:** queue clear-on-pass tests + migration debt docs + friction signals coverage (WO 3e1b30de/8ac4ef87/8b30fec0) (#298)
- **eval:** count_degraded_skills requires score < baseline, not just friction_flag (WO 3ca8be3a) (#296)
- **eval:** eliminate N+1 SQL patterns in aggregate_friction_signals (WO c6b6f3ed) (#295)
- **eval:** gate friction_flag on threshold count, not first signal (WO-EVAL-LOOP-THRESHOLD) (#293)
- **eval:** wire live runs into eval_registry + ds eval baseline --live (#291)
- **analytics:** remap ingestion from dropped tables to event spines (#286)
- **ci:** restore full-ci green — invocation tables, findings schema, test fixtures (#285)
- **schema-coherence:** include VIEWs in migration replay + register two Python-owned tables (#284)
- **migrations:** drop stale prd FK refs that broke archive_workflow on fresh DBs (#282)
- **tests:** rewrite stale _call_subagent mocks to use _run_graders_parallel API (#281)
- **marker-format:** add project-existence validation to _write_project_marker (#279)
- **marker-format:** parse JSON .dream-studio-project markers + ghost-marker guard (#278)
- **eval:** gate live-session eval mode with NotImplementedError; document fixture-only boundary (#277)
- **grader:** increase _collect_grader timeout 180→360s for large diff prompts (WO-GRADER-TIMEOUT) (#273)
- **grader:** extract first balanced JSON object from prose-prefixed output (WO-GRADER-JSON) (#272)
- recreate usage-table indexes lost to migration 081 + evergreen O7 audit test (WO-IDX-RECREATE) (#271)
- escalate docs-drift pre-push gate to blocking for CI parity (WO-GATE-PARITY) (#269)
- feed grader prompts via stdin, not argv (WO-GRADER-LOOKUP) (#268)
- grader commit lookup by WO title token + unreviewable verdicts (WO-GRADER-LOOKUP) (#267)
- narrow remaining broad swallow clauses in sqlite_bootstrap (WO-DEBT-I) (#263)
- correctness grader rules + try/except around verify in close.py (#262)
- document migration 116 hygiene + clarify deferred import in close.py (#261)
- **surfaces:** wire research router, fix security_events write path (#251)
- **setup:** sync hook projection subdirs and fix .plugin-root on every run (#246)
- **skills:** guard ds-core against shadowing SQLite task authority (#245)
- **ci:** remove dead verify_migrations test refs + pin PyJWT (#244)

### Refactors
- **telemetry:** facade-split read_models + emitters god files (WO-GF-TELEMETRY b1743e8b) (#545)
- **control:** facade-split detector/web/workflow-state/installer god files (WO-GF-CONTROL-INSTALL 7d593de6) (#544)
- **events:** facade-split canonical event types + registry (WO-GF-EVENT-TAXONOMY 7efad824) (#543)
- **core:** facade-split schema_coherence/doctor/eval-runner/dispatcher/rules_scanner (WO-GF-CORE-HEALTH-SKILLS 5a3e6d96) (#542)
- **core:** facade-split graph/query, document_store, memory/store, projects/mutations (WO-GF-CORE-DATA 2b10e7cf) (#541)
- **core:** facade-split projection framework + event_writer god files (WO-GF-PROJECTION-ENGINE 16e7d733) (#540)
- **api:** facade-split 6 fat projections/api route/lib modules (WO-GF-API-ROUTES 4e51dc29) (#539)
- **shared-intel:** facade-split contract_atlas/contract_registry/expert_workflows (WO-GF-SHARED-INTEL 9a47dbe1) (#538)
- **core:** facade-split WO-lifecycle god files verify/evals/close/start/milestones (WO-GF-WO-LIFECYCLE a0b07505) (#536)
- **cli:** split 6 CLI god files into facades + 25 siblings (WO-GF-CLI 0a462fa6) (#534)
- **core:** nested facade-split handoff_{security,build,validate} god files (WO-GF-WO-HANDOFF 59b6c0ad) (#533)
- **core:** facade-split readiness/analytics/insight god files (WO-GF-READINESS-INSIGHTS f0c0241e) (#532)
- **core:** facade-split installed_productization god file (WO-GF-INSTALLED-PROD 7237f962) (#530)
- **filesdb:** drop 2 redundant raw tables — raw_runtime_state + raw_session_token_accumulators (WO-FILESDB-REVET) (#513)
- **dashboard:** remove dead audit-history tab + Security Audits subtab (WO 12d24499) (#510)
- **schema:** drop audit_runs superseded external-write table (WO-SCHEMALEAN, migration 149) (#502)
- **schema:** drop the unwired preflight stack (WO-SCHEMALEAN, migration 148) (#501)
- **schema:** drop capability_route_records dead persist=False table (WO-SCHEMALEAN, migration 147) (#500)
- **event_store:** split studio_db.py into connection/writer/reader/migration behind a facade (a1217e95) (#482)
- **handoff:** split core/work_orders/handoff.py into modules behind a facade (e3a0f7f3) (#481)
