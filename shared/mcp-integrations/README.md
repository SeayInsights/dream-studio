...
**Artifacts:** Screenshots saved to `C:/Users/Example User/Downloads/agent-browser-test-*.png`
...
- `ds:quality` uses browser automation for UI verification
- `ds:security` uses DAST tools via browser control
- `ds:domains` uses browser for web scraping tasks
