...
```
C:\Users\Example User\claude_mcp\agent-browser-mcp
```
...
await mcp__firecrawl_mcp__firecrawl_browser_execute({
  sessionId: sessionId,
  code: "agent-browser screenshot C:/Users/Example User/Downloads/app-state.png",
  language: "bash"
});
...
await mcp__firecrawl_mcp__firecrawl_browser_execute({
  sessionId: baselineSession.sessionId,
  code: "agent-browser screenshot C:/Users/Example User/Downloads/baseline.png",
  language: "bash"
});
...
await mcp__firecrawl_mcp__firecrawl_browser_execute({
  sessionId: currentSession.sessionId,
  code: "agent-browser screenshot C:/Users/Example User/Downloads/current.png",
  language: "bash"
});
...
Claude: [Invokes ds:quality verify]
...
Path format: `C:/Users/Example User/Downloads/filename.png`
...
**Fix:**
- Always use forward slashes: `C:/Users/Example User/Downloads/test.png`
- Check Downloads folder exists: `Test-Path "C:\Users\Example User\Downloads"`
- Verify write permissions: `Get-Acl "C:\Users\Example User\Downloads"`
