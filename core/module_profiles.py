...
MODULE_PROFILES: tuple[dict[str, Any], ...] = (
    ...
    {
        "profile_id": "career_ops_only",
        "includes": ["career_ops_private_authority", "career_dashboard_private_routes"],
        "excludes": [
            "public_exports",
            "team_rollups",
            "demo_packets",
            "application_submission_without_approval",
            "account_creation",
            "captcha_bypass",
            "docker",
        ],
        "required_dependencies": ["python", "sqlite"],
        "optional_dependencies": ["playwright_for_approved_field_fill"],
        "exposed_commands": ["ds status", "ds modules"],
        "exposed_routes": ["/api/shared-intelligence/career-ops"],
        "hooks_required": False,
        "agents_required": False,
        "workflows_required": False,
        "claude_required": False,
        "codex_required": False,
        "docker_required": False,
        "expected_dashboard_api_behavior": "private_module_disabled_until_opt_in",
        "honest_empty_state": "Career Ops is disabled until explicitly enabled by the operator.",
        "privacy_boundary": "career_data_private_local_and_excluded_from_public_exports_by_default",
    },
    {
