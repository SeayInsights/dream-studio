...
MATURITY_AREAS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "known_gaps": [
            "Docker profiles are optional designs; containers are not started or required"
        ],
        "next_action": "Implement optional Docker runtime profiles only after separate approval.",
        "can_claim_publicly": True,
        "can_use_operationally": False,
    },
    {
        ...
        "status": "designed_not_proven",
        "owner_source": "core/shared_intelligence/contract_atlas.py",
        "evidence": ["Contract Atlas analytics-only profile"],
        "validation": ["tests/unit/test_contract_atlas.py"],
        "known_gaps": ["not yet packaged as a standalone runtime mode"],
        "next_action": "Expose analytics-only runtime option after dashboard profile maturity.",
        "can_claim_publicly": True,
        "can_use_operationally": False,
    },
    {
        ...
        "status": "designed_not_proven",
        "owner_source": "project registry and external validation docs",
        "evidence": ["tests/unit/test_external_project_dashboard_views.py"],
        "validation": ["paused target and external dashboard tests"],
        "known_gaps": ["external project mutation remains out of scope unless explicitly approved"],
        "next_action": "Build reusable external project pipeline under separate registry scope.",
        "can_claim_publicly": False,
        "can_use_operationally": False,
    },
    {
        ...
        "evidence": ["runtime/config/release-gates/dream-studio.json"],
        "validation": ["tests/unit/test_github_pr_cicd_release_gate.py"],
        "known_gaps": ["live GitHub polling/merge remains approval and CI-state dependent"],
        "next_action": "Use release gate during the next operator-approved push/PR cycle.",
        "can_claim_publicly": True,
        "can_use_operationally": True,
    },
    {
