...
_WORKFLOW_BASES: dict[str, dict[str, Any]] = {
    "api_integration_design_workflow": {
        ...
        "existing_owners": ["skills/fullstack", "core/production_readiness"],
        "overlap_status": {
            ...
            "evidence": ["skills/fullstack/SKILL.md", "core/production_readiness"],
    ...
    "seo_content_growth_workflow": {
        ...
        "existing_owners": ["skills/website", "docs/PUBLICATION_BOUNDARY.md"],
        "overlap_status": {
            "decision": "strengthen_existing",
            "overlap_reason": "Website domain owns public surfaces; publication boundary owns privacy limits.",
            "evidence": ["skills/website", "docs/PUBLICATION_BOUNDARY.md"],
