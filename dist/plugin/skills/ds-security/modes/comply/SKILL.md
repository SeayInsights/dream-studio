...
- 🟠 [L. Application security standards](../../references/regulatory-anchors.md#l-application-security-standards): OWASP ASVS v5.0.0 and CWE Top 25 are built-in compliance framework targets in the mapping definitions.
