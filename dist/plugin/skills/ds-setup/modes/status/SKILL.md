...
```
Tool               | Status           | Version                | What It Unlocks                                              | Install / Upgrade Command
GitHub CLI         | ⚠ outdated       | 2.38.0 (min: 2.40.0)   | ds-core · ds-domains             | (outdated, upgrade with: choco upgrade gh -y)
Firecrawl          | ✗ missing        | —                      | ds-core · ds-domains · ds-security | pip install firecrawl-py
Playwright         | ⚠ partial        | 1.42.0                 | ds-quality · ds-security                 | playwright install
Node Package Manager | ✓ installed    | 10.2.4                 | ds-domains · ds-workflow                 | —
Python             | ✓ installed      | Python 3.12.0          | ds-core · ds-quality + 2 more          | —
Node.js            | ✓ installed      | v20.11.0               | ds-domains · ds-workflow                 | —
```
...
3. If any tools are `missing` or `partial`, append:
   > Run `ds-setup wizard` to install or repair missing tools.
