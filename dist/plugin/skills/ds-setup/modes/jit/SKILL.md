...
JIT mode is invoked by OTHER skills (e.g., ds-core, ds-domains) when they detect that a specific tool is absent at runtime. It is NOT called directly by the user — it fires inline during a workflow without requiring the full wizard.
