...
### canonical/skills/code-health/references/code-writing-best-practices.md
...
### canonical/skills/code-health/shared/trust_boundary_detection.py
...
1. Add the pattern to `canonical/skills/code-health/shared/trust_boundary_detection.py`
