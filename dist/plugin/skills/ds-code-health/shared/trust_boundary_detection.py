"""Shared utility: external trust boundary detection for ds-code-health/ds-quality skills.
...
Location: canonical/skills/code-health/shared/ — shared across code-health-pack skills.
