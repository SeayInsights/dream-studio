...
<!-- GENERATED by integrations/compiler/agents.py from the website/design row of coverage.yml and the skill inlined
...
You are dispatched for **`website/design`**, and your domain knowledge below is that mode's skill. Work outside it is not yours to do.
...
# Domain knowledge — ds-website/modes/design/SKILL.md
