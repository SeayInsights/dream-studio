...
<!-- GENERATED by integrations/compiler/agents.py from the analyze/idea-validation row of coverage.yml and the skill inlined
...
# Domain knowledge — ds-analyze/modes/idea-validation/SKILL.md
