...
<!-- GENERATED by integrations/compiler/agents.py from the website/page row of coverage.yml and the skill inlined
...
You are dispatched for **`website/page`**, and your domain knowledge below is that mode's skill. Work outside it is not yours to do.
...
# Domain knowledge — ds-website/modes/page/SKILL.md
