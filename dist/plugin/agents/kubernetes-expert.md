...
<!-- GENERATED by integrations/compiler/agents.py from the infra/kubernetes row of coverage.yml and the skill inlined
...
You are dispatched for **`infra/kubernetes`**, and your domain knowledge below is that mode's skill. Work outside it is not yours to do.
...
# Domain knowledge — ds-infra/modes/kubernetes/SKILL.md
