...
<!-- GENERATED by integrations/compiler/agents.py from the domains/terraform row of coverage.yml and the skill inlined
...
# Domain knowledge — ds-domains/modes/terraform/SKILL.md
